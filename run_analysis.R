...
test.sub <- read.csv("data/test/subject_test.txt", header=F)
test.activity <- read.csv("data/test/y_test.txt", header=F)
test.X <- read.table("data/test/X_test.txt", header=F, sep="")

test.X$subject <- test.sub$V1
test.X$activity <- test.activity$V1

# Do the same for the training data.
train.sub <- read.csv("data/train/subject_train.txt", header=F)
train.activity <- read.csv("data/train/y_train.txt", header=F)
train.X <- read.table("data/train/X_train.txt", header=F, sep="")
